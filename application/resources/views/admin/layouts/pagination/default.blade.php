...
<nav>
    <ul class="pagination">
        ...
        <li class="page-item m-1 disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
        ...
        <li class="page-item m-1 active" aria-current="page"><span class="page-link">{{ $page }}</span></li>
        @else
        <li class="page-item m-1"><a class="page-link" href="{{ $url }}">{{ $page }}</a></li>
        @endif
        @endforeach
        @endif
        @endforeach
        ...
        @else
        <li class="page-item m-1 disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
