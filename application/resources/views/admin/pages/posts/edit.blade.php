                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body ">
                        <form role="form" action="{{ route('posts.update', $post) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <label>Titulo*</label>
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="Titulo" name="title" value="{{ $post->title }}" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="Subtitulo" name="subtitle" value="{{ $post->subtitle }}" required>
                                @error('subtitle')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control" placeholder="Video" name="youtube" value="{{ $post->youtube }}">
                                @error('youtube')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="active" {{ $post->active ? 'checked=""' : '' }}>
                                    <label class="form-check-label" for="active">Ativar</label>
                                    <input type="hidden" id="active-hidden" name="active" value="{{ $post->active }}">
                                </div>
                            ...
                            <div class="mb-3">
                                <textarea id="content" name="content" class="form-control" rows="10" cols="50">{{ $post->content }}</textarea>
                                @error('content')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
