...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Geek Noticias">
    <meta name="keywords" content="Anime, Geek, Teste, Laravel">
    ...
    <link rel="stylesheet" href="{{ asset('assets/site/css/plyr.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/site/css/nice-select.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/site/css/owl.carousel.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('assets/site/css/slicknav.min.css') }}" type="text/css">
